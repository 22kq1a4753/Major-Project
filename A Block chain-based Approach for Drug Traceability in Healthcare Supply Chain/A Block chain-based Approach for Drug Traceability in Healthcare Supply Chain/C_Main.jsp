...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3">A Block chain-based Approach for Drug Traceability in Healthcare Supply Chain</h1>
      </div>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="style2"></div>
          <div class="img">
            <div align="justify"><img src="images/img1.jpg" width="620" height="336" alt="" class="fl" /></div>
          </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="C_View_All_Datasets_Blockchain.jsp">View All Datasets Blockchain</a></strong></li>
			<li><strong><a href="C_View_All_Attackers.jsp">View All Attackers</a></strong></li>
			
			<li><strong><a href="C_View_Disease_Results.jsp">View Disease Results</a></strong></li>
		<li><strong><a href="C_View_Attacker_Results.jsp">View Attacker Results</a></strong></li>
