...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style5">A Block chain-based Approach for Drug Traceability in Healthcare Supply Chain</h1>
      </div>
          ...
          <ul class="sb_menu style4">
            <li><a href="O_Main.jsp">Home</a></li>
			 <li><a href="O_Upload_Datasets.jsp">Upload</a></li>
			  <li><a href="O_View_All_Uploaded_Datasets.jsp">View All Uploaded Datasets</a></li>
			 <li><a href="O_View_All_Attackers.jsp">View All Attackers</a></li>
