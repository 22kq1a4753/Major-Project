...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style20">A Block chain-based Approach for Drug Traceability in Healthcare Supply Chain</h1>
      </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="U_Search_Patient.jsp">Search and Decrypt Drug Details</a></li>
		   <li><a href="U_Login.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
